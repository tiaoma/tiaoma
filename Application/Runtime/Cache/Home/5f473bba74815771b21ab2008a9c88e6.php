...
<div class="contbox">
        ...
        <header class="mui-bar mui-bar-nav">
			<a href="<?php echo U('Policies/index');?>" class="mui-icon mui-icon-left-nav mui-pull-left"></a>
			<h1 class="mui-title">政策法规</h1>
		</header>
				...
				<div class="mui-card">
					...
					<div class="mui-card-content">
						<div class="mui-card-content-inner">               
	                       <p>发布时间：<?php echo (date('Y-m-d',$info[createtime])); ?></p>
