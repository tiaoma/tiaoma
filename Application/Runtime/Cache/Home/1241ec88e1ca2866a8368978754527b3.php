...
<div class="contbox">
		...
		<div class="mui-content  margintop normal">			 		 
			<div class="mui-content-padded">
			    
				<a class="mui-btn mui-pull-right mui-btn-primary submitBtn cbtn" href="<?php echo U('Ugoods/add');?>">添加商品</a>
		...
		<script>
			(function($) {
				...
				var ajax = function() {
					...
					var url = '<?php echo U("Ugoods/getlist");?>';
					//请求方式，默认为Get；
					var type = "get";
					//预期服务器范围的数据类型
					var dataType = "json";
