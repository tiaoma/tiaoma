 ...
 <table class="table">
    ...
    <tr>
        ...
        <td> 
            ...
            <label class="radio-inline" >
                <input type="radio" id="place-radio2" name="place" value="2"> 报班学习
            </label>
            <label class="radio-inline" >
                <input type="radio" id="place-radio2" name="place" value="3"> 免费试听
            </label>
            <label class="radio-inline" >
                <input type="radio" id="place-radio2" name="place" value="4"> 师资力量
            </label>
             <label class="radio-inline" >
                <input type="radio" id="place-radio2" name="place" value="5"> 模拟考试
            </label>
            <label class="radio-inline" >
                <input type="radio" id="place-radio2"  name="place" value="6"> 消防动态
            </label>
             <label class="radio-inline" >
                <input type="radio" id="place-radio2" name="place" value="7"> 就业前景
            </label>
             <label class="radio-inline" >
                <input type="radio" id="place-radio2" name="place" value="8"> 下载资料
            </label>
            <label class="radio-inline" >
                <input type="radio" id="place-radio2" name="place" value="9"> 在线课程
            </label>
        </td>
    </tr>
    <tr>
