...
<nav class="breadcrumb"><i class="iconfont">&#xf012b;</i> 首页 <span class="c-gray en">&gt;</span> 标准管理 <span class="c-gray en">&gt;</span> <?php if($info): ?>编辑<?php else: ?>添加<?php endif; ?>标准 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="icon-refresh"></i></a></nav>
...
<form class="Huiform" action="" method="post" enctype="multipart/form-data">
    ...
    <tr>
        ...
        <td><input type="text" value="<?php echo ($info['englishname']); ?>" maxlength="64" class="form-control" name="englishname"></td>
    </tr>   
     <tr>
        <th width="100">状态:</th>
        <td>
          ...
          <label class="radio-inline" >
            <input type="radio" id="inline-radio2" name="status" value="0" <?php if($info['status'] == 0): ?>checked<?php endif; ?>> 隐藏
          </label>
        </td>
      </tr>  
      <tr>
        <th width="100">标准号:</th>
        <td><input type="text" value="<?php echo ($info['standardnumber']); ?>" maxlength="64" class="form-control" name="standardnumber"></td>
      </tr>  
      <tr>
        <th width="100">标准类型:</th>
        <td>
            <label class="radio-inline">
                <input type="radio"  name="standardtype" checked value="1"> 国家标准
            </label>
        </td>
      </tr>
      <tr>
        <th width="100">标准状态:</th>
        <td>
            <label class="radio-inline">
            <input type="radio"  name="standardstatus" value="0" <?php if($info['standardstatus'] == 0): ?>checked<?php endif; ?>> 未生效
          </label>
          <label class="radio-inline" >
            <input type="radio"  name="standardstatus" value="1" <?php if($info['standardstatus'] == 1): ?>checked<?php endif; ?>> 现行
          </label>
           <label class="radio-inline" >
            <input type="radio"  name="standardstatus" value="2" <?php if($info['standardstatus'] == 2): ?>checked<?php endif; ?>> 废止
          </label>
        </td>
      </tr>
      <tr>
        <th width="100">中国标准分类号:</th>
        <td><input type="text" value="<?php echo ($info['ccs']); ?>" maxlength="64" class="form-control" name="ccs"></td>
      </tr>
       <tr>
        <th width="100">国际标准分类号:</th>
        <td><input type="text" value="<?php echo ($info['ics']); ?>" maxlength="64" class="form-control" name="ics"></td>
      </tr>
      <tr>
        <th width="100">发布日期:</th>
        <td><input type="text" value="<?php echo ($info['publicationdate']); ?>" maxlength="64" class="form-control" name="publicationdate"></td>
      </tr>
      <tr>
        <th width="100">实施日期:</th>
        <td><input type="text" value="<?php echo ($info['impldate']); ?>" maxlength="64" class="form-control" name="impldate"></td>
      </tr>
      <tr>
        <th width="100">主管部门:</th>
        <td><input type="text" value="<?php echo ($info['competentdepartment']); ?>" maxlength="64" class="form-control" name="competentdepartment"></td>
      </tr>
      <tr>
        <th width="100">归口单位:</th>
        <td><input type="text" value="<?php echo ($info['technicalcommittees']); ?>" maxlength="64" class="form-control" name="technicalcommittees"></td>
      </tr>
      <tr>
        <th width="100">发布单位:</th>
        <td><input type="text" value="<?php echo ($info['publishingunit']); ?>" maxlength="64" class="form-control" name="publishingunit"></td>
      </tr>
      <tr>
        <th width="100">摘要:</th>
      ...
      <tr>
        <th width="100">源文件:</th>
        <td>
          <input type="file" value=""  class="form-control" name="fsrc"  id="fimage2">
          <?php if($info['fsrc']): ?><div>
             <a href="/sptmcx/Public/Data<?php echo ($info['fsrc']); ?>" target="_blank">查看源文件</a>
          </div><?php endif; ?>
        </td>
      </tr>
