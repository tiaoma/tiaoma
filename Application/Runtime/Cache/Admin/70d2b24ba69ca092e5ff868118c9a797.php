...
<nav class="breadcrumb"><i class="iconfont">&#xf012b;</i> 首页 <span class="c-gray en">&gt;</span> 政策法规管理 <span class="c-gray en">&gt;</span> 政策列表 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="icon-refresh"></i></a></nav>
  ...
  <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tbody> 
                        <?php if($list): if(is_array($list)): foreach($list as $key=>$vo): ?><tr>                                
                                ...
                                <td  class="f-14">
                                    <a  href="<?php echo U('Policies/edit',array('id'=>$vo[id],'rand'=>rand(1,10000)));?>"  data-name="<?php echo ($vo[title]); ?>" data-id="<?php echo ($vo[id]); ?>">
                                        <i class="icon-edit"></i>          
                                    </a>
                                    <a  onclick="class_del(this)" class="ml-5" data-url="<?php echo U('Policies/del',array('id'=>$vo[id],'rand'=>rand(1,10000)));?>" href="###">
